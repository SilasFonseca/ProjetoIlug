...
<html lang="pt-br">
  ...
  <div class="site-wrap">
   ...
   include 'headerLogado.php'; ?>
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/casa1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>Casa em Maragogi</h1>
                <p class="mb-0">Maragogi, Alagoas</p>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="mb-4">
              <div class="slide-one-item home-slider owl-carousel">
                <div><img src="images/casa2_2.jpg" alt="Image" class="img-fluid"></div>
                <div><img src="images/casa3_2.jpg" alt="Image" class="img-fluid"></div>
                <div><img src="images/casa4.jpg" alt="Image" class="img-fluid"></div>
                <div><img src="images/casa5.jpg" alt="Image" class="img-fluid"></div>
              </div>
            </div>
          ...
          <div class="col-lg-3 ml-auto">
            ...
            <div class="mb-5">
              <h3 class="h5 text-black mb-3">Filtro</h3>
              <form action="#" method="post">
                <div class="form-group">
                  <input type="text" placeholder="O que gostaria de buscar?" class="form-control">
                </div>
                <div class="form-group">
                  <div class="select-wrap">
                      ...
                      <select class="form-control" name="" id="">
                        ...
                        <option value="" selected="">Casas</option>
                        <option value="">Litoral &amp;  Mar</option>                        
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
            ...
            <div class="d-block d-md-flex listing">
              <a href="listings-single.html" class="img d-block" style="background-image: url('images/casa1.jpg')"></a>
              <div class="lh-content">
                <span class="categoria">Apartamento</span>
                <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                <h3><a href="listings-single.html">Apartamento com vista para o mar</a></h3>
            ...
            <div class="d-block d-md-flex listing">
                <a href="listings-single.html" class="img d-block" style="background-image: url('images/casa2.jpg')"></a>
                <div class="lh-content">
                  <span class="categoria">Apartamento</span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="listings-single.html">Apartamento com vista para o mar</a></h3>
              ...
              <div class="d-block d-md-flex listing">
                <a href="listings-single.html" class="img d-block" style="background-image: url('images/casa3.jpg')"></a>
                <div class="lh-content">
                  <span class="categoria">Apartamento</span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="listings-single.html">Apartamento com vista para o mar</a></h3>
          ...
          <div class="col-lg-6">
            ...
            <div class="d-block d-md-flex listing">
              ...
              <div class="lh-content">
                ...
                <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                <h3><a href="listings-single.html">Casa de praia</a></h3>
                <address>Rua Divaldo Suruagy, Cidade Universitaria, Maceió</address>
                <p class="mb-0">
                  <span class="icon-star text-warning"></span>
                  <span class="icon-star text-warning"></span>
