          ...
          <div class="col-12  block-13">
            <div class="owl-carousel nonloop-block-13">
              ...
              <div class="d-block d-md-flex listing vertical">
                <a href="listings-single.php" class="img d-block" style="background-image: url('images/casa1.jpg')"></a>
                <div class="lh-content">
                  <span class="categoria"><? echo $row['ID']?></span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="listings-single.php"><? echo $row['TITULO']?></a></h3>
      ...
      <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
            ...
            <div class="d-block d-md-flex listing">
              ...
              <div class="lh-content">
                ...
                <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                <h3><a href="listings-single.php">Apartamento com vista para o mar</a></h3>
            ...
            <div class="d-block d-md-flex listing">
                <a href="listings-single.php" class="img d-block" style="background-image: url('images/casa2.jpg')"></a>
                <div class="lh-content">
                  <span class="categoria">Apartamento</span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="listings-single.php">Apartamento com vista para o mar</a></h3>
              ...
              <div class="d-block d-md-flex listing">
                <a href="listings-single.php" class="img d-block" style="background-image: url('images/casa3.jpg')"></a>
                <div class="lh-content">
                  <span class="categoria">Apartamento</span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="listings-single.php">Apartamento com vista para o mar</a></h3>
          ...
          <div class="col-lg-6">
            ...
            <div class="d-block d-md-flex listing">
              <a href="listings-single.php" class="img d-block" style="background-image: url('images/img_2.jpg')"></a>
              <div class="lh-content">
                <span class="categoria">Casa</span>
                <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                <h3><a href="listings-single.php">Casa de praia</a></h3>
                <address>Rua Divaldo Suruagy, Cidade Universitaria, Maceió</address>
                <p class="mb-0">
                  <span class="icon-star text-warning"></span>
                  <span class="icon-star text-warning"></span>
